...
//		passivate();
	...
	/**
	 * This method does a neighbor-to-neighbor 2D coupling of cells in a 2D
	 * space where each cell has 8 neighbors except the border cells.
	 * 
	 * @param otherID
	 *            neighbor ID
	 ...
	 * || idSE==id); else // all other cells return (idW==id || idE==id||
	 * idN==id || idS==id || idNW==id || idNE==id || idSW==id || idSE==id); }
	 */
	/**
